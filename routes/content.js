...
function ContentHandler (db) {
    ...
    this.displayPageByTag = function(req, res, next) {
        "use strict";
    ...
    this.handleEditedPost = function(req, res, next) {
        "use strict";

        var title = req.body.subject
        var post = req.body.body
        var tags = req.body.tags
        var prevPermalink = req.body.prevPermalink
        ...
        posts.editEntry(title, formatted_post, tags_array, prevPermalink, function(err, permalink) {
            "use strict";
            console.log('this is what they say: ' + permalink);
            if (err) return next(err);
    ...
    this.editPost = function(req, res, next) {
        ...
        posts.getPostByPermalink(permalink, function(err, post) {
            ...
            return res.render('edit_template', {
                username: req.username,
                post: post,
                errors: ""
            });
